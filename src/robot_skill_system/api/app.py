...
def create_app(service: Any | None = None) -> Any:
    ...
    from robot_skill_system.runtime.errors import PreflightError, RuntimeErrorBase
    ...
    async def runtime_failed(_request: Request, exc: RuntimeErrorBase) -> JSONResponse:
